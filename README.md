# Api De M Tricas Simples 1A6453

Aplicação backend `api-de-m-tricas-simples-1a6453` construída com foco em boas práticas de engenharia.

## Visão Geral
- Nome da aplicação: `api-de-m-tricas-simples-1a6453`
